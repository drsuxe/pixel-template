<template>
  <mp-drawer :is-open="isSidebarMenuOpen" :on-close="onSidebarMenuToggle" :return-focus-on-close="false">
    ...
    >
      <mp-drawer-body background-color="background" padding="0" max-height="calc(100vh)" overflow="hidden auto">
        <mp-flex align-items="center" border-radius="none" padding-x="4" padding-y="2.5" background-color="white">
          <mp-avatar name="Rizal Chandra" src="https://i.pravatar.cc/300" size="md" margin-right="2" :show-border="false" />
        ...
        <mp-box v-if="!isToggle" padding-x="2" padding-y="4" background-color="white">
          <mp-flex flex-direction="column" v-for="menu in menus" :key="menu.id">
            ...
            >
              <mp-stack direction="row" align="center" justify="space-between">
                <mp-flex gap="2">
                  <mp-icon :name="menu.icon" :color="menu.isActive ? 'blue.400' : 'inherit'" />
                  <mp-text white-space="nowrap" :font-weight="menu.isActive ? 'semibold' : 'inherit'">
                    {{ menu.name }}
                  </mp-text>
                </mp-flex>
                <mp-icon v-if="menu.isNested" name="chevrons-right" :color="black" />
              </mp-stack>
            </mp-pseudo-box>
            <mp-pseudo-box
              v-else
        ...
        <mp-box v-else padding-x="2" padding-y="4" background-color="white">
          ...
          <mp-divider />
          <mp-box>
            <mp-text font-size="md" font-weight="semibold" color="blue.400" padding-x="4" padding-y="2"> CHILD MENU </mp-text>
            <mp-box>
            ...
            <mp-accordion allow-toggle @change="handleChange">
              <mp-accordion-item border-bottom-width="0px!important">
                ...
                >
                  <mp-box>
                    <mp-flex direction="column">
                      <mp-pseudo-box flex="1" border-radius="sm" :color="isActive === 0 ? 'blue.400' : 'dark'">
                        <mp-stack direction="row" align="center">
                          <mp-text :font-weight="isActive === 0 ? 'semibold' : 'regular'">Child menu 3</mp-text>
                        </mp-stack>
                      </mp-pseudo-box>
                    </mp-flex>
                  </mp-box>
        ...
        <mp-box padding="4">
          <mp-flex flex-direction="column">
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Account settings </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Company info </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2">
              Company list
              <mp-icon name="chevrons-right" float="right" />
            </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Help & Support </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Change language </mp-text>
            <mp-divider />
            <mp-text as="a" href="#" color="gray.600" padding-y="2">
              Switch account
              <mp-icon name="chevrons-right" float="right" />
            ...
            <mp-divider />
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Privacy </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> Terms of Use </mp-text>
            <mp-text as="a" href="#" color="gray.600" padding-y="2"> About Mekari Account </mp-text>
