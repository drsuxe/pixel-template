...
export default {
  ...
  data() {
    return {
      ...
      generalFilterData: ["All notifications", "Reminder", "Mention", "Assignment", "Complete", "Download", "Upload"],
      generalData: [
        {
          date: "Today",
          data: [
            ...
            {
              title: "<b>Rizal Chandra</b> set a task to be due on <b>12 April 2022 at 11:11 (GMT+7)</b>.",
              date: "2 hours ago",
              icon: "overtime",
              type: "Reminder",
              isNew: true,
        ...
        },
        {
          ...
          data: [
            {
              title: "<b>Christin Purnama Sari</b> mentioned you on <b>Deals: MHJ Reports Enhancement.</b>.",
      ...
      needApprovalData: [
        {
          ...
          data: [
            {
              title: "<b>Christin Purnama Sari</b> has requested to move deals <b>Ajinomoto basic package</b> from Qualified to In progress.",
              date: "1 hour ago",
            ...
            {
              title: "<b>Rizal Chandra</b> has requested to update expense </b>27 May 2022</b> amount from IDR 600.000 to IDR 800.000.",
              date: "1 hour ago",
            ...
            {
              title: "<b>Rizal Chandra</b> has requested to add Deals <b>Pintap enterprise package</b> in stage New.",
              date: "1 hour ago",
              avatar: "https://i.pravatar.cc/300?img=12",
              link: "https://mekari.com",
              type: "Expenses",
