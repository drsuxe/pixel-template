<template>
  <mp-box>
    <mp-flex width="full" justify-content="space-between" mb="6">
      <mp-flex gap="4">
        <mp-autocomplete placeholder="Semua status" width="172px" id="semua-status" :data="['Semua status', 'Open', 'Closed']" />
      </mp-flex>
