<template>
  <mp-grid-item
    ...
    position="relative"
  >
    <mp-flex justifyContent="space-between" alignItems="center" mb="3">
      <mp-box>
    ...
    <mp-select v-model="value">
      <option value="PPh Pasal 23" size="sm">PPh Pasal 23</option>
    </mp-select>
    ...
    >
      ...
      >
        <mp-heading
          ...
          color="white"
          textAlign="center"
          >Buat dan bayar ID Billing Anda melalui Klikpajak</mp-heading
        >
